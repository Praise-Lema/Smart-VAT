...
Route::get('monthly-analysis', [PagesController::class, 'analysis'])->middleware([EnsureStatusIsActive::class, EnsurePackageIsSelected::class]);

Route::get('/purchase/export', [PurchasesExportController::class, 'export'])->middleware([EnsureStatusIsActive::class, EnsurePackageIsSelected::class]);

Route::get('company/change/{companyId}',[CompanyController::class, 'changeCompany']);
Route::get('/packages', [PagesController::class, 'packages'])->middleware([RedirectIfAlreadyPaid::class]);
Route::put('/packages/{id}', [PagesController::class, 'update']);
Route::get('/payment', [PagesController::class, 'payment_complete'])->middleware([RedirectIfAlreadyPaid::class, EnsurePackageIsSelected::class]);
...
Route::get('verify-payment', [PagesController::class, 'verify'])->middleware([RedirectIfAlreadyPaid::class, EnsurePackageIsSelected::class]);
